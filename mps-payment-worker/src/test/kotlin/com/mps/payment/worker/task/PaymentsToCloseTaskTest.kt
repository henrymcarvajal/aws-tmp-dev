...
import com.mps.payment.worker.util.createBankingInformation
import com.mps.payment.worker.util.createMerchantTest
import com.mps.payment.worker.util.createPaymentTest
...
class PaymentsToCloseTaskTest {
    ...
    private lateinit var paymentTask: PaymentsToCloseTask
